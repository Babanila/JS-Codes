...
var detail23 = ibisHotel.pool;
	...
	/*
			window.print(detail1 + " & " + detail2);
	 	// window.alert('Hello World');
    	// window.print();
  		// window.open("file:///Users/becky/Documents/Web%20Learning/HTML/multipleObject.html");
	...
	var wiw = window.innerWidth;
		document.write(ws);
		document.write(wsw + ' x ' + wsh + '<br>');
		document.write("  ");
		document.write(wiw + ' x ' + wih + '<br>');
	var wl = window.location;
	var wd = window.document;
		document.write('<br>' + wl + '<br>' + wd + '<br>');
	*/
