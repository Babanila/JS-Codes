...
var hotel = {
		...
		return this.roomPrice * ((100 - this.discount)/100);
		}
}
...
var elHotelRoomAvailability = document.getElementById('hotelRoomAvailable');
	elHotelRoomAvailability.textContent = hotelRoomAvailable + ' rooms left';
...
var hotelRoomDiscountPrice = hotel.discountPrice();
var	elHotelRoomDiscountPrice = document.getElementById('roomDiscountPrice');
	elHotelRoomDiscountPrice.textContent =  '$' + hotelRoomDiscountPrice;
